...
function App() {
  const { usersCollectionRef, eventsCollectionRef, profileCt, setProfileCt } =
    useAppContext();
  ...
  return (
    <>
      ...
      <div className="center event-header-container">
